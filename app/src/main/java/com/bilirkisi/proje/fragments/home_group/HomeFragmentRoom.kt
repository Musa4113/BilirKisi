package com.bilirkisi.proje.fragments.home_group
...
import com.bilirkisi.proje.databinding.HomeFragmentRoomBinding
...
import com.bilirkisi.proje.util.ClICKED_GROUP
...
class HomeFragmentRoom : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        //kayıtlı kullanıcı jetonunu alın ve kullanıcı belgesine ekleyin (for FCM)
...
//        }
    ...
    //    inflater.inflate(R.menu.main_menu_room, menu)     // grup ?
