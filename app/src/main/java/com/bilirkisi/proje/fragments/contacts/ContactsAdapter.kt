...
import com.bilirkisi.proje.databinding.ContactItemBinding
import com.bilirkisi.proje.fragments.findUser.mQuery
...
class ContactsAdapter(private val itemClickCallback: ItemClickCallback) :
    ...
    class UserHolder private constructor(val binding: ContactItemBinding) :
        ...
        fun bind(
            ...
            //Sorgu kutusu boş empty_box değilse : seçili metni gök mavisi + kalın olarak ayarlayın
            if (mQuery.isEmpty()) {
            ...
            //düğme tıklandığında üst parçaya geri arama
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            ...
            filterResults.values?.let {
                val mutableList = it as MutableList<User?>
